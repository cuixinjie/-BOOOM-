...
## - 音效通过 EventBus.sfx_requested 信号请求播放
##
## 创建人：cjs
## 创建日期：2026-04-28
## 合并日期：2026-05-02
...
var _bgm_bus: AudioStreamPlayer
...
func _ready() -> void:
	...
	_sfx_bus.bus = &"SFX"
	add_child(_sfx_bus)
	_bgm_bus = AudioStreamPlayer.new()
	_bgm_bus.bus = &"BGM"
	add_child(_bgm_bus)
